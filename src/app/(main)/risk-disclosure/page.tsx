...
export default function RiskDisclosurePage() {
  return <LegalPage eyebrow="Important information" title="Risk Disclosure" intro="Farm ownership can involve loss, delay, and operational uncertainty. Review these risks before you pay for an opportunity." sections={[
    { title: "No guaranteed return", content: <p>Any projected profit, yield, price, timeline, or other figure shown on Remote Agric is an estimate, not a guarantee. You may receive less than expected, receive nothing, or experience a delay.</p> },
