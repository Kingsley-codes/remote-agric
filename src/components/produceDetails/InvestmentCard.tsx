...
interface Props { produceId: string; unitPrice: number; fundedPercent: number; soldUnits: number; remainingUnits: number; minimumUnit: number; tracks: OpportunityTrack[]; rolloverInvestmentId?: string; }

export function InvestmentCard({ produceId, unitPrice, fundedPercent, soldUnits, remainingUnits, minimumUnit, tracks, rolloverInvestmentId }: Props) {
