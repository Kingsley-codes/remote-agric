  ...
  return (
    <section className="py-20 px-6 lg:px-20 max-w-7xl mx-auto">
      <div className="grid md:grid-cols-2 gap-16 items-center">
        <div>
          <h3 className="text-primary text-3xl font-semibold mb-6">
            Our Mission
          </h3>
          <p className="md:text-lg text-base leading-relaxed mb-6 opacity-90">
            At Remote Agric, we empower individuals and organizations by
            providing a seamless entry into the farming sector through
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-white p-8 rounded-lg shadow text-center border-t-6 border-[#D96C3A]">
            <div className="text-3xl font-black text-[#D96C3A] mb-2">
              <GiHighGrass className="inline mr-2" />
            </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow text-center border-t-6 border-[#F7B74A]">
            <div className="text-3xl font-black text-[#F7B74A] mb-2">
